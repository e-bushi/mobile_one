...
var columnOne = [Character?](repeatElement("🐯", count: 10))
var columnTwo = [Character?](repeatElement("🔥", count: 10))
var columnThree = [Character?](repeatElement("㊙️", count: 7))
grid.append(columnOne)
grid.append(columnTwo)
grid.append(columnThree)
grid[1][2] = "🈲"
