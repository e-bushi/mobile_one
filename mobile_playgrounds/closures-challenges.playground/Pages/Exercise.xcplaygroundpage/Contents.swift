...
doesApply(a: 85436, b: 53893, function: {(a, b) in
    if a % 3 == 0 && b % 3 == 0 {
        return true
    } else {
        return false
...
doesApply(a: 85436, b: 53893, function: {(a: Int, b: Int) in
    return sumOfDigits(a: a) == sumOfDigits(a: b) ? true : false
})

func manipulateStrings(a: String, b: String, function: (String, String) -> String?) -> String? {
    let str = function(a, b)
    return str
}


manipulateStrings(a: "abc", b: "def", function: {(a, b) -> String? in
    return a.count < 5 && b.count < 5 ? a+b : nil
})


manipulateStrings(a: "abcdef", b: "ghijkl") { a, b in
    return a.count < 5 && b.count < 5 ? a+b : nil }
