...
func myNameIs(_ name: Person?) -> String {
    if name != nil {
...
var maybePerson1 = Person(name: "Chris Mauldin")
var maybePerson2: Person? = nil

myNameIs(maybePerson1)
myNameIs(maybePerson2)

func myNameIs2(_ name: Person?) ->String {
